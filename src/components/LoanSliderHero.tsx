...
export const LoanSliderHero = ({ onGetStarted }: LoanSliderHeroProps) => {
  ...
  return (
    <section className="text-primary-foreground pt-6 pb-10 sm:pt-8 sm:pb-12 md:pt-10 md:pb-14">
      <div className="w-full max-w-2xl mx-auto px-4 sm:px-6 text-center">
        {/* Opening Sentence */}
        <h1 
          className="text-xl sm:text-2xl md:text-3xl font-semibold leading-tight mb-2 animate-slide-up"
        ...
        {/* Supporting Line */}
        <p 
          className="text-sm sm:text-base mb-6 animate-slide-up"
        ...
        {/* Slider Card */}
        <div 
          className="rounded-lg p-5 sm:p-6 md:p-8 mb-5 animate-slide-up"
          style={{ 
        ...
        >
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <button
              ...
              className="flex-shrink-0 w-10 h-10 sm:w-11 sm:h-11 rounded-full flex items-center justify-center transition-colors disabled:opacity-40"
              style={{ 
        ...
        <div className="animate-slide-up" style={{ animationDelay: "120ms" }}>
          <Button
            ...
            size="lg"
            className="text-base font-semibold px-12 py-6 h-auto gap-2"
            style={{
